...
void IntroStart(GSGLOBAL* gsGlobal)
{
	...
	strcat(tempi, INTROGAMEIMAGEPATH);
	gsKit_texture_png(gsGlobal, &IntroImageGame, tempi);
...
void IntroDraw(GSGLOBAL* gsGlobal, u64 colour)
{
	...
	gsKit_prim_sprite_texture(gsGlobal, &IntroImageGame,0,  // X1
						0,  // Y2
						0.0f,  // U1
						0.0f,  // V1
						IntroImage.Width *2, // X2
