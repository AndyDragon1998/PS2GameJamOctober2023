...
void MenuUpdate(GSGLOBAL* gsGlobal)
{
    ...
    else if(PlaystationGamePad.DOWN_KEY_TAP && selectedOption != 4)
    {
    	selectedOption++;
    }
...
void MenuDraw(GSGLOBAL* gsGlobal, u64 colour)
{
	...
	switch(selectedOption)
	{
		// Start New Game
		case 0:
			DrawText(240, 120, "YJDFZ BUHF",2, gsGlobal, &colour,1);
			DrawText(240, 155, "GHJLJK:BNM",2, gsGlobal, &colour,0);
			DrawText(240, 190, "EHJDYB",2, gsGlobal, &colour,0);
			DrawText(240, 225, "YFCNHJQRB",2, gsGlobal, &colour,0);
			DrawText(240, 260, "PFDTHIBNM BUHE",2, gsGlobal, &colour,0);
		break;
		case 1: 
	  		DrawText(240, 120, "YJDFZ BUHF",2, gsGlobal, &colour,0);
			DrawText(240, 155, "GHJLJK:BNM",2, gsGlobal, &colour,1);
			DrawText(240, 190, "EHJDYB",2, gsGlobal, &colour,0);
			DrawText(240, 225, "YFCNHJQRB",2, gsGlobal, &colour,0);
			DrawText(240, 260, "PFDTHIBNM BUHE",2, gsGlobal, &colour,0);
		break;
		case 2:
	   		DrawText(240, 120, "YJDFZ BUHF",2, gsGlobal, &colour,0);
			DrawText(240, 155, "GHJLJK:BNM",2, gsGlobal, &colour,0);
			DrawText(240, 190, "EHJDYB",2, gsGlobal, &colour,1);
			DrawText(240, 225, "YFCNHJQRB",2, gsGlobal, &colour,0);
			DrawText(240, 260, "PFDTHIBNM BUHE",2, gsGlobal, &colour,0);
		break;
		case 3:
			...
			DrawText(240, 155, "GHJLJK:BNM",2, gsGlobal, &colour,0);
			DrawText(240, 190, "EHJDYB",2, gsGlobal, &colour,0);
			DrawText(240, 225, "YFCNHJQRB",2, gsGlobal, &colour,1);
			DrawText(240, 260, "PFDTHIBNM BUHE",2, gsGlobal, &colour,0);
		break;
		case 4:
			DrawText(240, 120, "YJDFZ BUHF",2, gsGlobal, &colour,0);
			...
			DrawText(240, 190, "EHJDYB",2, gsGlobal, &colour,0);
			DrawText(240, 225, "YFCNHJQRB",2, gsGlobal, &colour,0);
			DrawText(240, 260, "PFDTHIBNM BUHE",2, gsGlobal, &colour,1);
		break;
		default:
	}
